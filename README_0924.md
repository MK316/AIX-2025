...
+ 2025년 12월 16 회의용
+ 본 요약서는 모든 전공을 아우르는 **AI 리터러시 교육 설계의 핵심 방향**과 **모듈 구조**, **운영 방안**, **기대 효과**를 1페이지 분량으로 정리한 것임.
+ (참고: 1-4번 제목은 링크로 되어 있고 추가 내용 페이지가 연결되어 있음.)
...
| | 분류 | 포함 예시 전공 |
|---|------|-----------|
|1| 언어·의미 중심형 | 국어, 영어, 외국어 |
|2|인간·사회·문화 해석형| 윤리, 사회, 역사, 철학 |
|3| 수치·기호 중심형 | (수학, 물리, 화학) 응용 영역 |
|4| 관찰·실험 중심형 | 생물, 지리 |
|5| 감각·표현 중심형 | 미술, 음악, 체육 |
...
| 영역 | 주요 내용 |
|------|-----------|
| 디지털리터러시 및 AI 이해 | 디지털 리터러시 및 AI 개념, 생성형 AI 체험 |
